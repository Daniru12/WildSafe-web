...
import { Shield, LogOut, LayoutDashboard, FileText, BarChart3, Menu, X, Globe, User, Plus, Package, Navigation2 } from 'lucide-react';
                        ...
                        <>
                            ...
                            {user?.role === 'OFFICER' && (
                                <>
                                    ...
                                    <Link to="/ranger-missions" onClick={() => setIsOpen(false)} className="flex items-center gap-2 text-text-muted font-medium transition-colors hover:text-primary">
                                        <Navigation2 size={18} />
